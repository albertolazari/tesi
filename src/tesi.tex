...
\usepackage{layaureo}	% layout simmetrico, per i pdf
%\usepackage[binding=9.5mm]{layaureo}	% layout simmetrico, per i pdf
...
\begin{document}
	...
	\chapter{L'azienda}
	\label{cap:azienda}   
	\input{capitoli/azienda}

	\chapter{Descrizione dello stage}
	\label{cap:descrizione-stage}
	\input{capitoli/descrizione-stage}

	\chapter{Analisi e refactor dei modelli}
	\label{cap:modelli}
	\input{capitoli/modelli}
