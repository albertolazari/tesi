...
\end{itemize}
Ho deciso di raccogliere queste informazioni in un unico modello, con i campi dell'entità \verb|e_partecipants|, a cui ho aggiunto l'immagine dell'utente, un enumerazione che ne indica il ruolo, invece di utilizzare un'intera entità come era stato fatto precedentemente. I campi necessari per l'autenticazione sono stati omessi, perché già presenti nel \emph{template} dei progetti di Moku.

La motivazione alla base della scelta di non codificare l'autorizzazione in un modello è stata la complessità di questo processo, che spesso dipende anche dall'oggetto su cui si vuole eseguire un'azione, qundi non esclusivamente dal ruolo dell'utente.
